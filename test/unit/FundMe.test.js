...
!developmentChains.includes(network.name)
    ? describe.skip //is current network not hardhat or localhost? if yes skip, if not, do describe function
    : describe("FundMe", async function () {
          ...
          describe("fund", async function () {
              ...
              it("Adds funder to array of funders ", async function () {
                  ...
                  const funder = await fundMe.getFunder(0) //function in FundMe.sol
              ...
              it("Withdraws ETH from a single founder", async function () {
                  ...
                  assert.equal(
                      startingDeployerBalance
                          ...
                          .toString(), // .add() is a solidity function
